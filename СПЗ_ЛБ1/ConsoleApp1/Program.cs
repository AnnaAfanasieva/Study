...
namespace ConsoleApp1
{
    public class Data
    {
        ...
        public int choice, price, pprice=0, menu, x, sum = 50,y,z,P=0;

    }

    class Program
    {
        static void State(Data data)
        {
        ...
        static void Menu(Data data)  { 
            ...
            Console.WriteLine("4 - Американо  13грн");
            Console.WriteLine("5 - Flat White 13грн");
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Кофемашина " + name);
            Console.WriteLine("");
            while (true) {
